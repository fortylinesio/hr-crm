...
ALTER TABLE IF EXISTS candidate ADD CONSTRAINT
    vacancy_id_pk FOREIGN KEY (vacancy_id) REFERENCES vacancy;

ALTER TABLE IF EXISTS vacancy ADD CONSTRAINT
...
ALTER TABLE IF EXISTS vacancy_competencies ADD CONSTRAINT
    vacancy_competencies_pk FOREIGN KEY (vacancy_id) REFERENCES vacancy;